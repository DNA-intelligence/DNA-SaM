...
class SingleEditCode:
    ...
    def encode(self, x):
        ...
        Parameters
        ----------
        x : QaryString of length (l)

        Returns
        -------
        x_enc :         QaryString of length (N)
        n :             Length of sum-balanced intermediate needed for decoding
        x_enc.length :  N
        l :             length of x                                                                                                                                                                 
        """
    ...
    def decode(self, x_enc, n, N, l, verbose=False):
        ...
        n, N, l: use quantities returned by encoder

        Returns
        -------
        x_dec :         Decoded QaryString of length (l)
        """
