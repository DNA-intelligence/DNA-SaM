...
LastEditTime: 2024-12-11 16:40:11
'''
"""
Name: Entry function
...
def encode(method, input_path, output_path,
           model_path=None, verify=None, need_index=True, segment_length=500, need_log=False, time=time()):
    """
    ...
    input_matrix, size = data_handle.read_binary_from_all(input_path, segment_length, need_log, time=time)
    ...
    data_handle.write_dna_file(output_path, dna_sequences, need_log, time=time)
